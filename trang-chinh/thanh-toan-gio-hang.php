...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4" style="background-color: rgb(29 35 62 / 70%);text-align: center">
                <div class="login">
            ...
            <div class="col-md-4" style="background-color: rgb(29 35 62 / 70%);text-align: center">
                <div class="logo">
                <a href="index.php" style="margin-top: 30px;"><img src="../../bigshoes/css/danh-sach-sp/img/y.png" alt="anh"></a>
                </div>
            </div>
            <div class="col-md-4" style="background-color: rgb(29 35 62 / 70%);text-align: center">
...
">
    ...
    <form action="" id="getinfo_form" method="post" name="dathang" enctype="application/x-www-form-urlencoded">
        <div class="row">
       
            <div class="col-sm-7">

            <!--  tí thay lại cái path này -->
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td style = "text-align:right;"><?=number_format(($price - ($price*($giam_gia/100)))*$sl);
                                    ...
                                    //reqruired 1 cai file moi luu cai total nay vao
                                    //roi ong qua thanhmomo goi ham ra dung la đc
                    ...
                    <tr><input type="hidden" name="total" value="<?=number_format($total)?>"/></tr>
                    <?php }} ?>
                    <tr>
                        <td><b>Tổng phụ</b></td>
                    ...
                    <tr><input type="hidden" value="<?=$total?>" name="total" /></tr>
                    <tr>
                   ...
                   <tr  class="phuongthuctt">
                        ...
                        <label for="op1">Chuyển khoản momo atm</label>

                        <br>

                        <input type="radio" id="op3" name="op1">
                        <label for="op3">Chuyển khoản momo QR</label>
                    ...
                    <tr>
                       <button class="buy" name="dathang" id="order" type="submit">Đặt hàng</button>
                    </tr>
                    </tbody>
                </table>        
                    ...
                    <input class="form-control" data-val="true" data-val-number="The field Amount must be a number." data-val-required="The Amount field is required." id="amount" max="100000000" min="1" name="amount" type="hidden" value="<?=number_format($total)?>" />
        ...
        <div class="row">
            <div class="container" style="margin-top: 50px;">
                <div class="row">
                    <div class="col-md-3">
                        <div class="fo">
                            <img src="../css/trang-chu/img/y.png" alt="" style ="width:60px;">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="fo">
...
<script>
    ...
    //chuyen khoan momo atm
    $('#op1').click(function() {
        // $('#order').attr('name', 'ordermomo');
        $('#getinfo_form').attr('action', '../../bigshoes/admin/dao/thanhtoanmomo.php');
    ...
    $('#op3').click(function() {
    // $('#order').attr('name', 'ordermomo');
    $('#getinfo_form').attr('action', '../../bigshoes/admin/dao/thanhtoanmomoqr.php');
